      ...
      >
        <HeroSection
          title={
            ...
            >
              Platinum: Cheksiz Imkoniyatlar va Eksklyuziv Imtiyozlar!
            </Typography>
          }
          subtitle={"PLATINUM"}
          desc={
            ...
            <div className="specialization__box">
              ...
              <div className="specialization__left">
                <p className="specialization__desc">
                  ...
                  strategiyalarini ishlab chiqishga ixtisoslashganmiz. Ular
                  o'sish, innovatsiyalar, yechimlar va bu farovonlik uchun
                  mustahkam rejalardir.Ular o'sish, innovatsiyalar, yechimlar va
                  bu farovonlik uchun mustahkam rejalardir.Ular o'sish,
                  innovatsiyalar, yechimlar va bu farovonlik uchun mustahkam
                  rejalardir.
                </p>
              </div>
            </div>
